...
class CargarDatos:
    ...
    def registrar_predicciones(model, y_test, preds):
        try:
            ...
            logging.exception(
                f'Error al registrar las predicciones del modelo: {model}'
            )
...
class Modelo:
    ...
    def registrar_inicio(self):
        ...
        try:
            ...
            logging.exception(
                f'Error al registrar el tiempo de inicio.'
            )
    def resgistrar_svm_preds(self, svm_preds, y_test):
        ...
        try:
            ...
            logging.exception(
                f'Error al registrar las predicciones de svm.'
            )
